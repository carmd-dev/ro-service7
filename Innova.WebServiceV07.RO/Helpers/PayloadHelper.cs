...
namespace Innova.WebServiceV07.RO.Helpers
{
    public static class PayloadHelper
    {
        ...
        public static void SavePayloadToFile(string externalSystemName, string newPayloadFolder, string fileName, string payloadInfo)
        {
            var folderName = DateTime.Now.ToString("yyyy-MM-dd");
            var fullPath = Path.Combine(newPayloadFolder, externalSystemName, folderName);
        ...
        public static void SavePayloadToFileByDay(string externalSystemName, string newPayloadFolder, string fileName, string payloadInfo)
        {
            try
            {
                var folderName = DateTime.Now.ToString("yyyy-MM-dd");
