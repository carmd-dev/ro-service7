...
namespace Innova.Vehicles
{
    ...
    /// (Remove the word "Collection" from VehicleCollection).
    /// Inherits from <see cref="BusinessObjectCollectionBase"/>.
    /// </summary>
    /// <example>
    /// To create the collection:
    ///
    /// <code>VehicleCollection c = new VehicleCollection(Registry);</code>
    /// </example>
    /// <remarks>
    /// In order to create an instance of VehicleCollection, you need to have a <see cref="Registry"/>
    ...
    /// </remarks>
    [Serializable()]
    public class VehicleCollection : BusinessObjectCollectionBase
    {
        ...
        /// <summary>
        /// Constructor creates a new VehicleCollection object.
        /// </summary>
        /// <param name="registry"><see cref="Registry"/> currently being used to store <see cref="BusinessObjectBase"/> objects.</param>
        public VehicleCollection(Registry registry) : base(registry)
        {
            businessObjectBaseType = typeof(Vehicle);
        }
        ...
        /// <summary>
        /// Gets the <see cref="BusinessObjectCollectionRelationDefinition"/> for loading the <see cref="Vehicle.PolkVehicleYMME"/> properties.
        /// </summary>
        public BusinessObjectCollectionRelationDefinition RelationPolkVehicleYMMEs
        {
            get
            {
        ...
        /// <summary>
        /// Indexer, used to return the <see cref="Vehicle"/> located at the index (<see cref="int"/>) position of the list.
        /// </summary>
        public Vehicle this[int index]
        {
            get
            {
                return (Vehicle)List[index];
            }
        }
        ...
        /// <summary>
        /// Adds an <see cref="Vehicle"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="Vehicle"/> to add.</param>
        ...
        /// <summary>
        /// Removes an <see cref="Vehicle"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="Vehicle"/> to remove.</param>
        ...
        /// <summary>
        /// Inserts an <see cref="Vehicle"/> object to the list.
        /// </summary>
        ...
        /// <summary>
        /// Creates the <see cref="Vehicle"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            Vehicle obj = (Vehicle)Registry.CreateInstance(typeof(Vehicle), dr.GetGuid(idField));
