...
namespace Innova.Vehicles
{
    ...
    /// (Remove the word "Collection" from VehicleTypeCollection).
    /// Inherits from <see cref="BusinessObjectCollectionBase"/>.
    /// </summary>
    /// <example>
    /// To create the collection:
    ///
    /// <code>VehicleTypeCollection c = new VehicleTypeCollection(Registry);</code>
    /// </example>
    /// <remarks>
    /// In order to create an instance of VehicleTypeCollection, you need to have a <see cref="Registry"/>
    ...
    /// </remarks>
    [Serializable()]
    public class VehicleTypeCollection : BusinessObjectCollectionBase
    {
        ...
        /// <summary>
        /// Constructor creates a new VehicleTypeCollection object.
        /// </summary>
        /// <param name="registry"><see cref="Registry"/> currently being used to store <see cref="BusinessObjectBase"/> objects.</param>
        public VehicleTypeCollection(Registry registry) : base(registry)
        {
            businessObjectBaseType = typeof(VehicleType);
        }
        ...
        /// <summary>
        /// Indexer, used to return the <see cref="VehicleType"/> located at the index (<see cref="int"/>) position of the list.
        /// </summary>
        public VehicleType this[int index]
        {
            get
            {
                return (VehicleType)List[index];
            }
        }
        ...
        /// <summary>
        /// Adds an <see cref="VehicleType"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="VehicleType"/> to add.</param>
        public void Add(VehicleType value)
        {
            base.Add(value);
        }

        /// <summary>
        /// Removes an <see cref="VehicleType"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="VehicleType"/> to remove.</param>
        ...
        /// <summary>
        /// Inserts an <see cref="VehicleType"/> object to the list.
        /// </summary>
        /// <param name="index"><see cref="int"/> index position inserting at</param>
        /// <param name="value"><see cref="VehicleType"/> to add</param>
        public void Insert(int index, VehicleType value)
        {
            base.Insert(index, value);
        }

        /// <summary>
        /// Creates the <see cref="VehicleType"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            VehicleType obj = (VehicleType)Registry.CreateInstance(typeof(VehicleType), dr.GetGuid(idField));
