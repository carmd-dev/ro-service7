...
namespace Innova.Vehicles
{
    /// <summary>
    ///
    /// The assignment of vehicle types to vehicle type error codes with the specific error code string supplied by the tool.
    ///
    /// The VehicleTypeCodeAssignment object handles the business logic and data access for the specialized business object, VehicleTypeCodeAssignment.
    /// The class inherits from <see cref="BusinessObjectBase"/> class.
    /// </summary>
    /// <example>
    /// See the examples of how to construct the VehicleTypeCodeAssignment object.
    ///
    /// To create a new instance of a new of VehicleTypeCodeAssignment.
    /// <code>VehicleTypeCodeAssignment o = (VehicleTypeCodeAssignment)Registry.CreateInstance(typeof(VehicleTypeCodeAssignment));</code>
    ///
    /// To create an new instance of an existing VehicleTypeCodeAssignment.
    /// <code>VehicleTypeCodeAssignment o = (VehicleTypeCodeAssignment)Registry.CreateInstance(typeof(VehicleTypeCodeAssignment), new Guid("{250426B4-3C7A-463c-93C4-045668C8A1AA}"));</code>
    /// </example>
    /// <remarks>
    /// In order to create an instance of VehicleTypeCodeAssignment, you need to have a <see cref="Registry"/>
    ...
    /// </remarks>
    [Serializable()]
    public class VehicleTypeCodeAssignment : BusinessObjectBase
    {
        ...
        /// <summary>
        /// Constructor creates a new (one that does not exist, assigning a new <see cref="Guid"/> Id). VehicleTypeCodeAssignment object.
        /// In order to create a new VehicleTypeCodeAssignment which inherits from <see cref="BusinessObjectBase"/>, you need to use the <see cref="Registry"/>.
        /// </summary>
        /// <example>
        /// <code>
        /// VehicleTypeCodeAssignment o = (VehicleTypeCodeAssignment)Registry.CreateInstance(typeof(VehicleTypeCodeAssignment));
        /// </code>
        /// </example>
        protected internal VehicleTypeCodeAssignment() : base()
        {
        ...
        /// <summary>
        /// Constructor creates an existing (one that exists, and already has a <see cref="Guid"/> Id).  VehicleTypeCodeAssignment object.
        /// In order to create an existing VehicleTypeCodeAssignment object, which inherits from <see cref="BusinessObjectBase"/>, you need to use the <see cref="Registry"/>.
        /// </summary>
        /// <param name="id">The <see cref="Guid"/> or SQL uniqueidentifier indentification "Id" of the current object.</param>
        /// <example>
        /// <code>
        /// VehicleTypeCodeAssignment o = (VehicleTypeCodeAssignment)Registry.CreateInstance(typeof(VehicleTypeCodeAssignment), new Guid("{250426B4-3C7A-463c-93C4-045668C8A1AA}"));
        /// </code>
        /// </example>
        protected internal VehicleTypeCodeAssignment(Guid id) : base(id)
        {
            this.id = id;
        }
        ...
        /// <summary>
        /// Gets or sets the <see cref="VehicleType"/>  vehicle type associated with the assignment.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="VehicleTypeCode"/> vehicle type error code associated with the assignment.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="string"/> sent up from the tool used to lookup the error conditions for the data uploaded.
        /// </summary>
		...
		*******************************************************************************************/
        ...
        public new SqlTransaction Load(SqlConnection connection, SqlTransaction transaction, bool isLoadBase)
        {
            ...
            if (isLoadBase)
            {
                //load the base vehicleTypeCodeAssignment if user selected it.
        ...
        {
            dr.ProcedureName = "VehicleTypeCodeAssignment_Load";
            dr.AddGuid("VehicleTypeCodeAssignmentId", Id);
        }
        ...
        {
            vehicleType = (VehicleType)Registry.CreateInstance(typeof(VehicleType), dr.GetGuid("VehicleTypeId"));
            vehicleTypeCode = (VehicleTypeCode)Registry.CreateInstance(typeof(VehicleTypeCode), dr.GetGuid("VehicleTypeCodeId"));
        ...
        public override SqlTransaction Save(SqlConnection connection, SqlTransaction transaction)
        {
            ...
            if (IsObjectDirty)
            {
                ...
                using (SqlDataReaderWrapper dr = new SqlDataReaderWrapper(connection, false))
                {
                    if (IsObjectCreated)
                    {
                        dr.ProcedureName = "VehicleTypeCodeAssignment_Create";
                    }
                    else
                    {
                        dr.ProcedureName = "VehicleTypeCodeAssignment_Save";
                    }

                    dr.AddGuid("VehicleTypeCodeAssignmentId", this.Id);
