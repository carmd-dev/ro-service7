...
namespace Innova.Vehicles
{
    ...
    ///
    /// <code>VehicleWarrantyDetailCollection c = new VehicleWarrantyDetailCollection(Registry);</code>
    /// </example>
    /// <remarks>
    /// In order to create an instance of VehicleWarrantyDetailCollection, you need to have a <see cref="Registry"/>
    ...
    /// </remarks>
    [Serializable()]
    public class VehicleWarrantyDetailCollection : BusinessObjectCollectionBase
    {
        ...
        /// <summary>
        /// Constructor creates a new VehicleWarrantyDetail object.
        /// </summary>
        /// <param name="registry"><see cref="Registry"/> currently being used to store <see cref="BusinessObjectBase"/> objects.</param>
        public VehicleWarrantyDetailCollection(Registry registry)
            : base(registry)
        {
            businessObjectBaseType = typeof(VehicleWarrantyDetail);
        }
        ...
        /// <summary>
        /// Indexer, used to return the <see cref="VehicleWarrantyDetail"/> located at the index (<see cref="int"/>) position of the list.
        /// </summary>
        public VehicleWarrantyDetail this[int index]
        {
            get
            {
                return (VehicleWarrantyDetail)List[index];
            }
        }
        ...
        /// <summary>
        /// Adds an <see cref="VehicleWarrantyDetail"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="VehicleWarrantyDetail"/> to add.</param>
        public void Add(VehicleWarrantyDetail value)
        {
            base.Add(value);
        }

        /// <summary>
        /// Removes an <see cref="VehicleWarrantyDetail"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="VehicleWarrantyDetail"/> to remove.</param>
        public void Remove(VehicleWarrantyDetail value)
        {
            base.Remove(value);
        }

        /// <summary>
        /// Inserts an <see cref="VehicleWarrantyDetail"/> object to the list.
        /// </summary>
        /// <param name="index"><see cref="int"/> index position inserting at</param>
        /// <param name="value"><see cref="VehicleWarrantyDetail"/> to add</param>
        public void Insert(int index, VehicleWarrantyDetail value)
        {
            base.Insert(index, value);
        }

        /// <summary>
        /// Creates the <see cref="VehicleWarrantyDetail"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            VehicleWarrantyDetail obj = (VehicleWarrantyDetail)Registry.CreateInstance(typeof(VehicleWarrantyDetail), dr.GetGuid(idField));
