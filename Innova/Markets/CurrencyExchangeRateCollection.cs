...
namespace Innova.Markets
{
    ...
    ///
    /// <code>CurrencyExchangeRateCollection c = new CurrencyExchangeRateCollection(Registry);</code>
    /// </example>
    /// <remarks>
    /// In order to create an instance of CurrencyExchangeRateCollection, you need to have a <see cref="Registry"/>
    ...
    /// </remarks>
    [Serializable()]
    public class CurrencyExchangeRateCollection : BusinessObjectCollectionBase
    {
        ...
        /// <summary>
        /// Constructor creates a new CurrencyExchangeRate object.
        /// </summary>
        /// <param name="registry"><see cref="Registry"/> currently being used to store <see cref="BusinessObjectBase"/> objects.</param>
        public CurrencyExchangeRateCollection(Registry registry)
            : base(registry)
        {
            businessObjectBaseType = typeof(CurrencyExchangeRate);
        }
        ...
        /// <summary>
        /// Indexer, used to return the <see cref="CurrencyExchangeRate"/> located at the index (<see cref="int"/>) position of the list.
        /// </summary>
        public CurrencyExchangeRate this[int index]
        {
            get
            {
                return (CurrencyExchangeRate)List[index];
            }
        }
        ...
        /// <summary>
        /// Adds an <see cref="CurrencyExchangeRate"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="CurrencyExchangeRate"/> to add.</param>
        public void Add(CurrencyExchangeRate value)
        {
            base.Add(value);
        }

        /// <summary>
        /// Removes an <see cref="CurrencyExchangeRate"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="CurrencyExchangeRate"/> to remove.</param>
        public void Remove(CurrencyExchangeRate value)
        {
            base.Remove(value);
        }

        /// <summary>
        /// Inserts an <see cref="CurrencyExchangeRate"/> object to the list.
        /// </summary>
        /// <param name="index"><see cref="int"/> index position inserting at</param>
        /// <param name="value"><see cref="CurrencyExchangeRate"/> to add</param>
        public void Insert(int index, CurrencyExchangeRate value)
        {
            base.Insert(index, value);
        }

        /// <summary>
        /// Creates the <see cref="CurrencyExchangeRate"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            CurrencyExchangeRate obj = (CurrencyExchangeRate)Registry.CreateInstance(typeof(CurrencyExchangeRate), dr.GetGuid(idField));
