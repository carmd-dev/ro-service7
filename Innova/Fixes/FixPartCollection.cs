...
namespace Innova.Fixes
{
    ...
    /// </remarks>
    [Serializable()]
    public class FixPartCollection : BusinessObjectCollectionBase
    {
        ...
        public FixPartCollection(Registry registry) : base(registry)
        {
            businessObjectBaseType = typeof(FixPart);
        }
        ...
        /// <summary>
        /// Indexer, used to return the <see cref="FixPart"/> located at the index (<see cref="int"/>) position of the list.
        /// </summary>
        public FixPart this[int index]
        {
            get
            {
                return (FixPart)List[index];
            }
        }
        ...
        /// <summary>
        /// Adds an <see cref="FixPart"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="FixPart"/> to add.</param>
        public void Add(FixPart value)
        {
            base.Add(value);
        }

        /// <summary>
        /// Removes an <see cref="FixPart"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="FixPart"/> to remove.</param>
        public void Remove(FixPart value)
        {
            base.Remove(value);
        }

        /// <summary>
        /// Inserts an <see cref="FixPart"/> object to the list.
        /// </summary>
        /// <param name="index"><see cref="int"/> index position inserting at</param>
        /// <param name="value"><see cref="FixPart"/> to add</param>
        public void Insert(int index, FixPart value)
        {
            base.Insert(index, value);
        }

        /// <summary>
        /// Creates the <see cref="FixPart"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            FixPart obj = (FixPart)Registry.CreateInstance(typeof(FixPart), dr.GetGuid(idField));
