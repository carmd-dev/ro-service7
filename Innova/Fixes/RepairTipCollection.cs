...
namespace Innova.Fixes
{
    ...
    /// </remarks>
    [Serializable()]
    public class RepairTipCollection : BusinessObjectCollectionBase
    {
        ...
        public RepairTipCollection(Registry registry) : base(registry)
        {
            businessObjectBaseType = typeof(RepairTip);
        }
        ...
        /// </summary>
        public RepairTip this[int index] => (RepairTip)List[index];
        ...
        /// <summary>
        /// Adds an <see cref="RepairTip"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="RepairTip"/> to add.</param>
        public void Add(RepairTip value)
        {
            base.Add(value);
        }

        /// <summary>
        /// Removes an <see cref="RepairTip"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="RepairTip"/> to remove.</param>
        public void Remove(RepairTip value)
        {
            base.Remove(value);
        }

        /// <summary>
        /// Inserts an <see cref="RepairTip"/> object to the list.
        /// </summary>
        /// <param name="index"><see cref="int"/> index position inserting at</param>
        /// <param name="value"><see cref="RepairTip"/> to add</param>
        public void Insert(int index, RepairTip value)
        {
            base.Insert(index, value);
        }

        /// <summary>
        /// Creates the <see cref="RepairTip"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            RepairTip obj = (RepairTip)Registry.CreateInstance(typeof(RepairTip), dr.GetGuid(idField));
