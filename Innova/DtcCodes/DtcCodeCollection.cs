...
namespace Innova.DtcCodes
{
    ...
    /// (Remove the word "Collection" from DtcCodeCollection).
    /// Inherits from <see cref="BusinessObjectCollectionBase"/>.
    /// </summary>
    /// <example>
    /// To create the collection:
    ///
    /// <code>DtcCodeCollection c = new DtcCodeCollection(Registry);</code>
    /// </example>
    /// <remarks>
    /// In order to create an instance of DtcCodeCollection, you need to have a <see cref="Registry"/>
    ...
    /// </remarks>
    [Serializable()]
    public class DtcCodeCollection : BusinessObjectCollectionBase
    {
        ...
        /// <summary>
        /// Constructor creates a new DtcCodeCollection object.
        /// </summary>
        /// <param name="registry"><see cref="Registry"/> currently being used to store <see cref="BusinessObjectBase"/> objects.</param>
        public DtcCodeCollection(Registry registry) : base(registry)
        {
            businessObjectBaseType = typeof(DtcCode);
        }
        ...
        /// <summary>
        /// Indexer, used to return the <see cref="DtcCode"/> located at the index (<see cref="int"/>) position of the list.
        /// </summary>
        public DtcCode this[int index]
        {
            get
            {
                return (DtcCode)List[index];
            }
        }
        ...
        /// <summary>
        /// Adds an <see cref="DtcCode"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="DtcCode"/> to add.</param>
        public void Add(DtcCode value)
        {
            base.Add(value);
        }

        /// <summary>
        /// Removes an <see cref="DtcCode"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="DtcCode"/> to remove.</param>
        public void Remove(DtcCode value)
        {
            base.Remove(value);
        }

        /// <summary>
        /// Inserts an <see cref="DtcCode"/> object to the list.
        /// </summary>
        /// <param name="index"><see cref="int"/> index position inserting at</param>
        /// <param name="value"><see cref="DtcCode"/> to add</param>
        public void Insert(int index, DtcCode value)
        {
            base.Insert(index, value);
        }

        /// <summary>
        /// Creates the <see cref="DtcCode"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            DtcCode obj = (DtcCode)Registry.CreateInstance(typeof(DtcCode), dr.GetGuid(idField));
