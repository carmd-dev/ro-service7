...
namespace Innova.DtcCodes
{
    ...
    /// (Remove the word "Collection" from DtcMasterCodeListCollection).
    /// Inherits from <see cref="BusinessObjectCollectionBase"/>.
    /// </summary>
    /// <example>
    /// To create the collection:
    ///
    /// <code>DtcMasterCodeListCollection c = new DtcMasterCodeListCollection(Registry);</code>
    /// </example>
    /// <remarks>
    /// In order to create an instance of DtcMasterCodeListCollection, you need to have a <see cref="Registry"/>
    ...
    /// </remarks>
    [Serializable()]
    public class DtcMasterCodeListCollection : BusinessObjectCollectionBase
    {
        ...
        /// <summary>
        /// Constructor creates a new DtcMasterCodeListCollection object.
        /// </summary>
        /// <param name="registry"><see cref="Registry"/> currently being used to store <see cref="BusinessObjectBase"/> objects.</param>
        public DtcMasterCodeListCollection(Registry registry) : base(registry)
        {
            businessObjectBaseType = typeof(DtcMasterCodeList);
        }
        ...
        /// <summary>
        /// Indexer, used to return the <see cref="DtcMasterCodeList"/> located at the index (<see cref="int"/>) position of the list.
        /// </summary>
        public DtcMasterCodeList this[int index]
        {
            get
            {
                return (DtcMasterCodeList)List[index];
            }
        }
        ...
        /// <summary>
        /// Adds an <see cref="DtcMasterCodeList"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="DtcMasterCodeList"/> to add.</param>
        public void Add(DtcMasterCodeList value)
        {
            base.Add(value);
        }

        /// <summary>
        /// Removes an <see cref="DtcMasterCodeList"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="DtcMasterCodeList"/> to remove.</param>
        public void Remove(DtcMasterCodeList value)
        {
            base.Remove(value);
        }

        /// <summary>
        /// Inserts an <see cref="DtcMasterCodeList"/> object to the list.
        /// </summary>
        /// <param name="index"><see cref="int"/> index position inserting at</param>
        /// <param name="value"><see cref="DtcMasterCodeList"/> to add</param>
        public void Insert(int index, DtcMasterCodeList value)
        {
            base.Insert(index, value);
        }

        /// <summary>
        /// Creates the <see cref="DtcMasterCodeList"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            DtcMasterCodeList obj = (DtcMasterCodeList)Registry.CreateInstance(typeof(DtcMasterCodeList), dr.GetGuid(idField));
