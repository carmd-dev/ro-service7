...
namespace Innova.RetailerTools
{
    ...
    /// </remarks>
    [Serializable()]
    public class ToolCategory : InnovaBusinessObjectBase
    {
        private string name = "";
        ...
        //#ToolSelect02
        private NullableGuid parentToolCategoryId;
        ...
        ///
        /// </summary>
        protected internal ToolCategory()
            : base()
        {
        ...
        /// </summary>
        /// <param name="id"></param>
        protected internal ToolCategory(Guid id)
            : base(id)
        {
            this.id = id;
        }
        ...
        /// </summary>
        public NullableGuid ParentToolCategoryId
        {
            get
            {
                this.EnsureLoaded();
                return this.parentToolCategoryId;
            }
            set
            {
                this.EnsureLoaded();
                if (value != this.parentToolCategoryId)
                {
                    this.IsObjectDirty = true;
                    this.parentToolCategoryId = value;
                    this.UpdatedField("ParentToolCategoryId");
                }
            }
        }
        ...
        public string Name_Translated
        {
            ...
            {
                this.EnsureLoaded();
                return this.RuntimeInfo.GetTranslatedValue(this.Name, this.Name_es, this.Name_fr, "");
            }
        }
        ...
        public int CategoryLevel
        {
            ...
            {
                this.EnsureLoaded();
                if (value != this.category_level)
                {
                    this.IsObjectDirty = true;
                    this.category_level = value;
                    this.UpdatedField("CategoryLevel");
                }
            }
        }
		...
		*******************************************************************************************/
        ...
        /// </summary>
        /// <returns></returns>
        public static ToolCategoryCollection LoadAll(Registry registry)
        {
            ToolCategoryCollection toolCategories = new ToolCategoryCollection(registry);

            SqlProcedureCommand call = new SqlProcedureCommand();
            call.ProcedureName = "ToolCategory_LoadAll";

            toolCategories.Load(call, "ToolCategoryId", true, true, false);
        ...
        /// <returns></returns>
        public static ToolCategory GetByName(Registry registry, string name)
        {
            using (SqlDataReaderWrapper dr = new SqlDataReaderWrapper(registry.ConnectionStringDefault))
            {
                dr.ProcedureName = "ToolCategory_LoadByName";
                ...
                if (dr.Read())
                {
                    ToolCategory toolCategory = (ToolCategory)dr.GetBusinessObjectBase(registry, typeof(ToolCategory), "ToolCategoryId");
                    toolCategory.LoadPropertiesFromDataReader(dr, true);
                    return toolCategory;
                }
            }
        ...
        /// <returns></returns>
        public static Guid GetRowId(Registry registry, string sql)
        {
            Guid rowId = Guid.Empty;
            using (SqlConnection connection = new SqlConnection(registry.ConnectionStringDefault))
            {
        ...
        ///
        /// </summary>
        public bool IsAssociatedToTool
        {
            get
            {
                using (SqlDataReaderWrapper dr = new SqlDataReaderWrapper(this.Registry.ConnectionStringDefault))
                {
                    dr.ProcedureName = "ToolCategory_IsAssociatedToTool";
                    dr.AddGuid("ToolCategoryId", this.Id);

                    dr.Execute();

                    if (dr.Read())
                    {
                        return dr.GetBoolean("IsAssociated");
                    }
                }
        ...
        {
            dr.ProcedureName = "ToolCategory_Load";
            dr.AddGuid("ToolCategoryId", this.Id);
        }
        ...
        protected new void SetPropertiesFromDataReader(SqlDataReaderWrapper dr)
        {
            ...
            this.name_es = dr.GetSysNullableString("Name_es");
            this.name_fr = dr.GetSysNullableString("Name_fr");
            this.category_level = dr.GetInt32("CategoryLevel");
            ...
            this.parentToolCategoryId = dr.GetNullableGuid("ParentToolCategoryId");

            //#ToolManagement
            this.codemasterId = dr.GetSysNullableString("CodemasterId");
            this.aaia = dr.GetSysNullableString("AAIA");
        ...
        public override SqlTransaction Save(SqlConnection connection, SqlTransaction transaction)
        {
            ...
            if (this.IsObjectDirty)
            {
                ...
                using (SqlDataReaderWrapper dr = new SqlDataReaderWrapper(connection, false))
                {
                    if (this.IsObjectCreated)
                    {
                        dr.ProcedureName = "ToolCategory_Create";
                    }
                    else
                    {
                        //#ToolManagement
                        dr.ProcedureName = "ToolCategory_Save";
                        //dr.UpdateFields("ToolCategory", "ToolCategoryId", this.updatedFields);
                    }
                    ...
                    dr.AddInt32("CategoryLevel", this.CategoryLevel);
                    ...
                    //#ToolManagement
                    dr.AddNVarChar("CodemasterId", this.CodeMasterId.Trim());
                    dr.AddNVarChar("AAIA", this.AAIA.Trim());

                    //
                    dr.AddGuid("ParentCategoryId",
                        this.ParentToolCategoryId != Guid.Empty ? this.ParentToolCategoryId : NullableGuid.Null);
                    //
        ...
        public override SqlTransaction Delete(SqlConnection connection, SqlTransaction transaction)
        {
            ...
            {
                //delete the item
                dr.ProcedureName = "ToolCategory_Delete";
                dr.AddGuid("ToolCategoryId", this.Id);
