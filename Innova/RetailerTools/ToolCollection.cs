...
namespace Innova.RetailerTools
{
    ...
    /// </remarks>
    [Serializable()]
    public class ToolCollection : BusinessObjectCollectionBase
    {
        ...
        public ToolCollection(Registry registry) : base(registry)
        {
            businessObjectBaseType = typeof(Tool);
        }
        ...
        /// <summary>
        /// Gets the <see cref="BusinessObjectCollectionRelationDefinition"/> for loading the <see cref="ToolName"/> property.
        /// </summary>
        public BusinessObjectCollectionRelationDefinition RelationToolName
        {
            get
            {
                SqlProcedureCommand call = new SqlProcedureCommand();
                call.ProcedureName = "ToolName_LoadByXmlGuidList";
                return new BusinessObjectCollectionRelationDefinition(typeof(ToolName), "ToolName.Id", "XmlGuidList", call, "ToolNameId", true, true);
            }
        }
        ...
        /// <summary>
        /// Indexer, used to return the <see cref="Tool"/> located at the index (<see cref="int"/>) position of the list.
        /// </summary>
        public Tool this[int index]
        {
            get
            {
                return (Tool)List[index];
            }
        }
        ...
        /// <summary>
        /// Adds an <see cref="Tool"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="Tool"/> to add.</param>
        ...
        /// <summary>
        /// Removes an <see cref="Tool"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="Tool"/> to remove.</param>
        ...
        /// <summary>
        /// Inserts an <see cref="Tool"/> object to the list.
        /// </summary>
        ...
        /// <summary>
        /// Creates the <see cref="Tool"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            Tool obj = (Tool)Registry.CreateInstance(typeof(Tool), dr.GetGuid(idField));
