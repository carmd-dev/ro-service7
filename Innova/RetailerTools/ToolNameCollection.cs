...
namespace Innova.RetailerTools
{
    ...
    /// </remarks>
    [Serializable()]
    public class ToolNameCollection : BusinessObjectCollectionBase
    {
        ...
        public ToolNameCollection(Registry registry)
            : base(registry)
        {
            businessObjectBaseType = typeof(ToolName);
        }
        ...
        /// <summary>
        /// Indexer, used to return the <see cref="ToolName"/> located at the index (<see cref="int"/>) position of the list.
        /// </summary>
        public ToolName this[int index] => (ToolName)List[index];
        ...
        /// <summary>
        /// Adds an <see cref="ToolName"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="ToolName"/> to add.</param>
        public void Add(ToolName value)
        {
            base.Add(value);
        }

        /// <summary>
        /// Removes an <see cref="ToolName"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="ToolName"/> to remove.</param>
        public void Remove(ToolName value)
        {
            base.Remove(value);
        }

        /// <summary>
        /// Inserts an <see cref="ToolName"/> object to the list.
        /// </summary>
        /// <param name="index"><see cref="int"/> index position inserting at</param>
        /// <param name="value"><see cref="ToolName"/> to add</param>
        public void Insert(int index, ToolName value)
        {
            base.Insert(index, value);
        }

        /// <summary>
        /// Creates the <see cref="ToolName"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            ToolName obj = (ToolName)Registry.CreateInstance(typeof(ToolName), dr.GetGuid(idField));
