...
{
    /// <summary>
    /// The PartOEM object handles the business logic and data access for the specialized business object, PartOEM.
    /// The class inherits from <see cref="BusinessObjectBase"/> class.
    /// </summary>
    /// <example>
    /// See the examples of how to construct the PartOEM object.
    ///
    /// To create a new instance of a new of PartOEM.
    /// <code>PartOEM o = (PartOEM)this.Registry.CreateInstance(typeof(PartOEM));</code>
    ///
    /// To create an new instance of an existing PartOEM.
    /// <code>PartOEM o = (PartOEM)this.Registry.CreateInstance(typeof(PartOEM), new Guid("{250426B4-3C7A-463c-93C4-045668C8A1AA}"));</code>
    /// </example>
    /// <remarks>
    /// In order to create an instance of PartOEM, you need to have a <see cref="Registry"/>
    ...
    /// </remarks>
    [Serializable()]
    public class PartOEM : BusinessObjectBase
    {
        private NullableInt32 acesBaseVehicleId = NullableInt32.Null;
        private NullableInt32 acesEngineBaseId = NullableInt32.Null;
        private NullableInt32 acesPartTypeId = NullableInt32.Null;
        private NullableInt32 quantity = NullableInt32.Null;
        private string retailer = "";
        private string manufacturer = "";
        private string oemPartNumber = "";
        private string codemasterID = "";
        private NullableInt32 acesSubModelId = NullableInt32.Null;
        ...
        /// <summary>
        /// Constructor creates a new (one that does not exist, assigning a new <see cref="Guid"/> Id). PartOEM object.
        /// In order to create a new PartOEM which inherits from <see cref="BusinessObjectBase"/>, you need to use the <see cref="Registry"/>.
        /// </summary>
        /// <example>
        /// <code>
        /// PartOEM o = (PartOEM)Registry.CreateInstance(typeof(PartOEM));
        /// </code>
        /// </example>
        protected internal PartOEM() : base()
        {
        ...
        /// <summary>
        /// Constructor creates an existing (one that exists, and already has a <see cref="Guid"/> Id).  PartOEM object.
        /// In order to create an existing PartOEM object, which inherits from <see cref="BusinessObjectBase"/>, you need to use the <see cref="Registry"/>.
        /// </summary>
        /// <param name="id">The <see cref="Guid"/> or SQL uniqueidentifier indentification "Id" of the current object.</param>
        /// <example>
        /// <code>
        /// PartOEM o = (PartOEM)Registry.CreateInstance(typeof(PartOEM), new Guid("{250426B4-3C7A-463c-93C4-045668C8A1AA}"));
        /// </code>
        /// </example>
        protected internal PartOEM(Guid id) : base(id)
        {
            this.id = id;
        }
        ...
        /// </summary>
        public NullableInt32 AcesBaseVehicleId
        {
            get
            {
                this.EnsureLoaded();
            ...
            {
                this.EnsureLoaded();
                if (value != this.acesBaseVehicleId)
                {
                    this.IsObjectDirty = true;
        ...
        /// Gets or sets the <see cref="NullableInt32"/> .
        /// </summary>
        public NullableInt32 AcesEngineBaseId
        {
            get
            {
                this.EnsureLoaded();
            ...
            {
                this.EnsureLoaded();
                if (value != this.acesEngineBaseId)
                {
                    this.IsObjectDirty = true;
        ...
        /// Gets or sets the <see cref="NullableInt32"/> .
        /// </summary>
        public NullableInt32 AcesPartTypeId
        {
            get
            {
                this.EnsureLoaded();
                return this.acesPartTypeId;
            }
            set
            {
                this.EnsureLoaded();
                if (value != this.acesPartTypeId)
                {
                    this.IsObjectDirty = true;
                    this.acesPartTypeId = value;
                    this.UpdatedField("AcesPartTypeId");
                }
            }
        }
        ...
        /// Gets or sets the <see cref="NullableInt32"/> .
        /// </summary>
        public NullableInt32 AcesSubModelId
        {
            get
            {
                this.EnsureLoaded();
	 ...
	 * **********************************************************************************************/
        ...
        /// <summary>
        /// Returns a populated DiagnosticReportResultFixPartPartOem object.
        /// </summary>
        /// <returns>Returns a populated <see cref="DiagnosticReportResultFixPartPartOem"/> object</returns>
        public DiagnosticReportResultFixPartPartOem ToDiagnosticReportResultFixPartPartOEM()
        {
            DiagnosticReportResultFixPartPartOem drrFixPart = (DiagnosticReportResultFixPartPartOem)this.Registry.CreateInstance(typeof(DiagnosticReportResultFixPartPartOem));

            drrFixPart.Manufacturer = this.Manufacturer;
            drrFixPart.OemPartNumber = this.OemPartNumber;
            drrFixPart.Retailer = this.Retailer;
            drrFixPart.PartOem = this;

            return drrFixPart;
        }

        /// <summary>
        /// Gets a <see cref="List{String}"/> of the part manufacturers.
        /// </summary>
        /// <param name="registry">The <see cref="Registry"/> currently in use.</param>
        /// <returns>A <see cref="List{String}"/> of the part manufacturers.</returns>
        public static List<string> GetPartManufacturers(Registry registry)
        {
            List<string> partManufacturers = new List<string>();

            using (SqlDataReaderWrapper dr = new SqlDataReaderWrapper(registry.ConnectionStringDefault))
            {
                dr.ProcedureName = "PartOEM_GetManufacturers";
                dr.Execute();

                while (dr.Read())
                {
                    partManufacturers.Add(dr.GetString("Manufacturer"));
                }
            }
        ...
        {
            dr.ProcedureName = "PartOEM_Load";
            dr.AddGuid("PartOEMId", this.Id);
        }
        ...
        {
            this.acesBaseVehicleId = dr.GetNullableInt32("AcesBaseVehicleId");
            this.acesEngineBaseId = dr.GetNullableInt32("AcesEngineBaseId");
            this.acesPartTypeId = dr.GetNullableInt32("AcesPartTypeId");
            this.quantity = dr.GetNullableInt32("Quantity");
            ...
            this.acesSubModelId = dr.GetNullableInt32("AcesSubModelId");
        ...
        public new void SetPropertiesToDataReader(SqlDataReaderWrapper dr, bool isCreate)
        {
            if (isCreate)
            {
                dr.ProcedureName = "PartOem_Create";
            ...
            else
            {
                ...
                dr.UpdateFields("PartOem", "PartOemId", this.updatedFields);
            }

            dr.AddGuid("PartOemId", this.Id);
            dr.AddInt32("AcesBaseVehicleId", this.AcesBaseVehicleId);
            dr.AddInt32("AcesEngineBaseId", this.AcesEngineBaseId);
            dr.AddInt32("AcesPartTypeId", this.AcesPartTypeId);
            dr.AddInt32("Quantity", this.Quantity);
            dr.AddNVarChar("Retailer", this.Retailer);
            dr.AddNVarChar("Manufacturer", this.Manufacturer);
            dr.AddNVarChar("OemPartNumber", this.OemPartNumber);
        ...
        public override SqlTransaction Delete(SqlConnection connection, SqlTransaction transaction)
        {
            ...
            {
                //delete the item
                dr.ProcedureName = "PartOEM_Delete";
                dr.AddGuid("PartOEMId", this.Id);
