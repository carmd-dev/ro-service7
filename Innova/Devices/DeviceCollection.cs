...
namespace Innova.Devices
{
    ...
    /// (Remove the word "Collection" from DeviceCollection).
    /// Inherits from <see cref="BusinessObjectCollectionBase"/>.
    /// </summary>
    /// <example>
    /// To create the collection:
    ///
    /// <code>DeviceCollection c = new DeviceCollection(Registry);</code>
    /// </example>
    /// <remarks>
    /// In order to create an instance of DeviceCollection, you need to have a <see cref="Registry"/>
    ...
    /// </remarks>
    [Serializable()]
    public class DeviceCollection : BusinessObjectCollectionBase
    {
        ...
        /// <summary>
        /// Constructor creates a new DeviceCollection object.
        /// </summary>
        /// <param name="registry"><see cref="Registry"/> currently being used to store <see cref="BusinessObjectBase"/> objects.</param>
        public DeviceCollection(Registry registry) : base(registry)
        {
            businessObjectBaseType = typeof(Device);
        }
        ...
        /// <summary>
        /// Indexer, used to return the <see cref="Device"/> located at the index (<see cref="int"/>) position of the list.
        /// </summary>
        ...
        /// <summary>
        /// Adds an <see cref="Device"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="Device"/> to add.</param>
        ...
        /// <summary>
        /// Removes an <see cref="Device"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="Device"/> to remove.</param>
        ...
        /// <summary>
        /// Inserts an <see cref="Device"/> object to the list.
        /// </summary>
        /// <param name="index"><see cref="int"/> index position inserting at</param>
        /// <param name="value"><see cref="Device"/> to add</param>
        public void Insert(int index, Device value)
        {
            base.Insert(index, value);
        }

        /// <summary>
        /// Creates the <see cref="Device"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            Device obj = (Device)Registry.CreateInstance(typeof(Device), dr.GetGuid(idField));
