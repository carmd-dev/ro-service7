...
namespace Innova.Articles
{
    ...
    /// (Remove the word "Collection" from ArticleCollection).
    /// Inherits from <see cref="BusinessObjectCollectionBase"/>.
    /// </summary>
    /// <example>
    /// To create the collection:
    ///
    /// <code>ArticleCollection c = new ArticleCollection(Registry);</code>
    /// </example>
    /// <remarks>
    /// In order to create an instance of ArticleCollection, you need to have a <see cref="Registry"/>
    ...
    /// </remarks>
    [Serializable()]
    public class ArticleCollection : BusinessObjectCollectionBase
    {
        ...
        /// <summary>
        /// Constructor creates a new ArticleCollection object.
        /// </summary>
        /// <param name="registry"><see cref="Registry"/> currently being used to store <see cref="BusinessObjectBase"/> objects.</param>
        public ArticleCollection(Registry registry) : base(registry)
        {
            businessObjectBaseType = typeof(Article);
        }
        ...
        /// <summary>
        /// Indexer, used to return the <see cref="Article"/> located at the index (<see cref="int"/>) position of the list.
        /// </summary>
        ...
        /// <summary>
        /// Adds an <see cref="Article"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="Article"/> to add.</param>
        ...
        /// <summary>
        /// Removes an <see cref="Article"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="Article"/> to remove.</param>
        ...
        /// <summary>
        /// Inserts an <see cref="Article"/> object to the list.
        /// </summary>
        ...
        /// <summary>
        /// Creates the <see cref="Article"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            Article obj = (Article)Registry.CreateInstance(typeof(Article), dr.GetGuid(idField));
