...
namespace Innova.Users
{
    ...
    ///
    /// <code>ExternalSystemCollection c = new ExternalSystemCollection(Registry);</code>
    /// </example>
    /// <remarks>
    /// In order to create an instance of ExternalSystemCollection, you need to have a <see cref="Registry"/>
    ...
    /// </remarks>
    [Serializable()]
    public class ExternalSystemCollection : BusinessObjectCollectionBase
    {
        ...
        /// <summary>
        /// Constructor creates a new ExternalSystem object.
        /// </summary>
        /// <param name="registry"><see cref="Registry"/> currently being used to store <see cref="BusinessObjectBase"/> objects.</param>
        public ExternalSystemCollection(Registry registry)
            : base(registry)
        {
            businessObjectBaseType = typeof(ExternalSystem);
        }
        ...
        /// <summary>
        /// Indexer, used to return the <see cref="ExternalSystem"/> located at the index (<see cref="int"/>) position of the list.
        /// </summary>
        public ExternalSystem this[int index]
        {
            get
            {
                return (ExternalSystem)List[index];
            }
        }
        ...
        /// <summary>
        /// Adds an <see cref="ExternalSystem"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="ExternalSystem"/> to add.</param>
        public void Add(ExternalSystem value)
        {
            base.Add(value);
        }

        /// <summary>
        /// Removes an <see cref="ExternalSystem"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="ExternalSystem"/> to remove.</param>
        public void Remove(ExternalSystem value)
        {
            base.Remove(value);
        }

        /// <summary>
        /// Inserts an <see cref="ExternalSystem"/> object to the list.
        /// </summary>
        /// <param name="index"><see cref="int"/> index position inserting at</param>
        /// <param name="value"><see cref="ExternalSystem"/> to add</param>
        public void Insert(int index, ExternalSystem value)
        {
            base.Insert(index, value);
        }

        /// <summary>
        /// Creates the <see cref="ExternalSystem"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            ExternalSystem obj = (ExternalSystem)Registry.CreateInstance(typeof(ExternalSystem), dr.GetGuid(idField));
