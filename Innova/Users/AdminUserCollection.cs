...
namespace Innova.Users
{
    ...
    /// (Remove the word "Collection" from AdminUserCollection).
    /// Inherits from <see cref="BusinessObjectCollectionBase"/>.
    /// </summary>
    /// <example>
    /// To create the collection:
    ///
    /// <code>AdminUserCollection c = new AdminUserCollection(Registry);</code>
    /// </example>
    /// <remarks>
    /// In order to create an instance of AdminUserCollection, you need to have a <see cref="Registry"/>
    ...
    /// </remarks>
    [Serializable()]
    public class AdminUserCollection : BusinessObjectCollectionBase
    {
        ...
        /// <summary>
        /// Constructor creates a new AdminUserCollection object.
        /// </summary>
        /// <param name="registry"><see cref="Registry"/> currently being used to store <see cref="BusinessObjectBase"/> objects.</param>
        public AdminUserCollection(Registry registry) : base(registry)
        {
            businessObjectBaseType = typeof(AdminUser);
        }
        ...
        /// <summary>
        /// Indexer, used to return the <see cref="AdminUser"/> located at the index (<see cref="int"/>) position of the list.
        /// </summary>
        public AdminUser this[int index]
        {
            get
            {
                return (AdminUser)List[index];
            }
        }
        ...
        /// <summary>
        /// Adds an <see cref="AdminUser"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="AdminUser"/> to add.</param>
        public void Add(AdminUser value)
        {
            base.Add(value);
        }

        /// <summary>
        /// Removes an <see cref="AdminUser"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="AdminUser"/> to remove.</param>
        public void Remove(AdminUser value)
        {
            base.Remove(value);
        }

        /// <summary>
        /// Inserts an <see cref="AdminUser"/> object to the list.
        /// </summary>
        /// <param name="index"><see cref="int"/> index position inserting at</param>
        /// <param name="value"><see cref="AdminUser"/> to add</param>
        public void Insert(int index, AdminUser value)
        {
            base.Insert(index, value);
        }

        /// <summary>
        /// Creates the <see cref="AdminUser"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            AdminUser obj = (AdminUser)Registry.CreateInstance(typeof(AdminUser), dr.GetGuid(idField));
