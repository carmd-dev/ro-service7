...
namespace Innova.DiagnosticReports
{
    ...
    /// </remarks>
    [Serializable()]
    public class DiagnosticReportFixFeedbackPart : InnovaBusinessObjectBase
    {
        ...
        /// </code>
        /// </example>
        protected internal DiagnosticReportFixFeedbackPart() : base()
        {
        ...
        /// </code>
        /// </example>
        protected internal DiagnosticReportFixFeedbackPart(Guid id)
            : base(id)
        {
            this.id = id;
        }
        ...
        /// PartNameId
        /// </summary>
        public string PartNameId
        {
            get
            {
                this.EnsureLoaded();
                return this.partNameId;
            }
            set
            {
                this.EnsureLoaded();
                if (this.partNameId != value)
                {
                    this.IsObjectDirty = true;
                    this.partNameId = value;
		...
		*******************************************************************************************/
        ...
        {
            dr.ProcedureName = "DiagnosticReportFixFeedbackPart_Load";
            dr.AddGuid("DiagnosticReportFixFeedbackPartId", Id);
        }
        ...
        protected new void SetPropertiesFromDataReader(SqlDataReaderWrapper dr)
        {
            ...
            this.partName = dr.GetString("PartName");
            this.partNumber = dr.GetString("PartNumber");
            //#AI_Update
            this.partNameId = dr.GetString("PartNameId");
        ...
        public override SqlTransaction Save(SqlConnection connection, SqlTransaction transaction)
        {
            ...
            if (IsObjectDirty)
            {
                ...
                using (SqlDataReaderWrapper dr = new SqlDataReaderWrapper(connection, false))
                {
                    if (IsObjectCreated)
                    {
                        dr.ProcedureName = "DiagnosticReportFixFeedbackPart_Create";
                    }
                    else
                    {
                        dr.ProcedureName = "DiagnosticReportFixFeedbackPart_Save";
                        dr.UpdateFields("DiagnosticReportFixFeedbackPart", "DiagnosticReportFixFeedbackPartId", this.updatedFields);
                    }

                    dr.AddGuid("DiagnosticReportFixFeedbackPartId", this.Id);
                    dr.AddGuid("DiagnosticReportFixFeedbackId", this.DiagnosticReportFixFeedback.Id);
                    dr.AddNVarChar("PartName", this.PartName);
            ...
            */
            ...
            using (SqlDataReaderWrapper dr = new SqlDataReaderWrapper(connection, false))
            {
                ...
                */
                ...
                //delete the fixPart
                dr.ProcedureName = "DiagnosticReportFixFeedbackPart_Delete";
                dr.AddGuid("DiagnosticReportFixFeedbackPartId", Id);
    ...
    /// </summary>
    [Serializable]
    public class FixFeedbackPart
    {
        /// <summary>
        /// Default constructor for the part needed object.
        /// </summary>
        public FixFeedbackPart()
        {
            this.Id = new Guid();
        }
        ...
        public FixFeedbackPart(FixFeedback fixFeedback)
        {
            this.Id = new Guid();
        ...
        /// </summary>
        public string PartRowId { get; set; }
    }
}