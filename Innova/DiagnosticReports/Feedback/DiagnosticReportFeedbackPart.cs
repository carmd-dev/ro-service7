...
{
    /// <summary>
    /// The DiagnosticReportFeedbackPart object handles the business logic and data access for the specialized business object, DiagnosticReportFeedbackPart.
    /// The class inherits from <see cref="BusinessObjectBase"/> class.
    /// </summary>
    /// <example>
    /// See the examples of how to construct the DiagnosticReportFeedbackPart object.
    ///
    /// To create a new instance of a new of DiagnosticReportFeedbackPart.
    /// <code>DiagnosticReportFeedbackPart o = (DiagnosticReportFeedbackPart)Registry.CreateInstance(typeof(DiagnosticReportFeedbackPart));</code>
    ///
    /// To create an new instance of an existing DiagnosticReportFeedbackPart.
    /// <code>DiagnosticReportFeedbackPart o = (DiagnosticReportFeedbackPart)Registry.CreateInstance(typeof(DiagnosticReportFeedbackPart), new Guid("{250426B4-3C7A-463c-93C4-045668C8A1AA}"));</code>
    /// </example>
    /// <remarks>
    /// In order to create an instance of DiagnosticReportFeedbackPart, you need to have a <see cref="Registry"/>
    ...
    /// </remarks>
    [Serializable()]
    public class DiagnosticReportFeedbackPart : BusinessObjectBase
    {
        ...
        /// <summary>
        /// Constructor creates a new (one that does not exist, assigning a new <see cref="Guid"/> Id). DiagnosticReportFeedbackPart object.
        /// In order to create a new DiagnosticReportFeedbackPart which inherits from <see cref="BusinessObjectBase"/>, you need to use the <see cref="Registry"/>.
        /// </summary>
        /// <example>
        /// <code>
        /// DiagnosticReportFeedbackPart o = (DiagnosticReportFeedbackPart)Registry.CreateInstance(typeof(DiagnosticReportFeedbackPart));
        /// </code>
        /// </example>
        protected internal DiagnosticReportFeedbackPart() : base()
        {
        ...
        /// <summary>
        /// Constructor creates an existing (one that exists, and already has a <see cref="Guid"/> Id).  DiagnosticReportFeedbackPart object.
        /// In order to create an existing DiagnosticReportFeedbackPart object, which inherits from <see cref="BusinessObjectBase"/>, you need to use the <see cref="Registry"/>.
        /// </summary>
        /// <param name="id">The <see cref="Guid"/> or SQL uniqueidentifier indentification "Id" of the current object.</param>
        /// <example>
        /// <code>
        /// DiagnosticReportFeedbackPart o = (DiagnosticReportFeedbackPart)Registry.CreateInstance(typeof(DiagnosticReportFeedbackPart), new Guid("{250426B4-3C7A-463c-93C4-045668C8A1AA}"));
        /// </code>
        /// </example>
        protected internal DiagnosticReportFeedbackPart(Guid id) : base(id)
        {
            this.id = id;
        }
		...
		*******************************************************************************************/
        ...
        public new SqlTransaction Load(SqlConnection connection, SqlTransaction transaction, bool isLoadBase)
        {
            ...
            if (isLoadBase)
            {
                //load the base diagnosticReportFeedbackPart if user selected it.
        ...
        {
            dr.ProcedureName = "DiagnosticReportFeedbackPart_Load";
            dr.AddGuid("DiagnosticReportFeedbackPartId", Id);
        }
        ...
        protected new void SetPropertiesFromDataReader(SqlDataReaderWrapper dr)
        {
            ...
            partDescription = dr.GetString("PartDescription");
            unitPrice = dr.GetDecimal("UnitPrice");
            quantity = dr.GetInt32("Quantity");
            extendedPrice = dr.GetDecimal("ExtendedPrice");
        ...
        public override SqlTransaction Save(SqlConnection connection, SqlTransaction transaction)
        {
            ...
            if (IsObjectDirty)
            {
                ...
                using (SqlDataReaderWrapper dr = new SqlDataReaderWrapper(connection, false))
                {
                    if (IsObjectCreated)
                    {
                        dr.ProcedureName = "DiagnosticReportFeedbackPart_Create";
                    }
                    else
                    {
                        dr.ProcedureName = "DiagnosticReportFeedbackPart_Save";
                    }

                    dr.AddGuid("DiagnosticReportFeedbackPartId", Id);
                    dr.AddGuid("DiagnosticReportFeedbackId", DiagnosticReportFeedback.Id);
                    dr.AddNVarChar("PartNumber", PartNumber);
                    dr.AddNVarChar("PartDescription", PartDescription);
                    dr.AddDecimal("UnitPrice", Math.Round(UnitPrice, 2));
                    dr.AddInt32("Quantity", Quantity);
                    dr.AddDecimal("ExtendedPrice", Math.Round(ExtendedPrice, 2));
        ...
        public override SqlTransaction Delete(SqlConnection connection, SqlTransaction transaction)
        {
            ...
            using (SqlDataReaderWrapper dr = new SqlDataReaderWrapper(connection, false))
            {
                //delete the diagnosticReportFeedbackPart
                dr.ProcedureName = "DiagnosticReportFeedbackPart_Delete";
                dr.AddGuid("DiagnosticReportFeedbackPartId", Id);
