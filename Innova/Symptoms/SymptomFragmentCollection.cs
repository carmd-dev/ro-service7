...
namespace Innova.Symptoms
{
    ...
    ///
    /// <code>SymptomFragmentCollection c = new SymptomFragmentCollection(Registry);</code>
    /// </example>
    /// <remarks>
    /// In order to create an instance of SymptomFragmentCollection, you need to have a <see cref="Registry"/>
    ...
    /// </remarks>
    [Serializable()]
    public class SymptomFragmentCollection : BusinessObjectCollectionBase
    {
        ...
        /// <summary>
        /// Constructor creates a new SymptomFragment object.
        /// </summary>
        /// <param name="registry"><see cref="Registry"/> currently being used to store <see cref="BusinessObjectBase"/> objects.</param>
        public SymptomFragmentCollection(Registry registry)
            : base(registry)
        {
            businessObjectBaseType = typeof(SymptomFragment);
        }
        ...
        /// <summary>
        /// Indexer, used to return the <see cref="SymptomFragment"/> located at the index (<see cref="int"/>) position of the list.
        /// </summary>
        public SymptomFragment this[int index]
        {
            get
            {
                return (SymptomFragment)List[index];
            }
        }
        ...
        /// <summary>
        /// Adds an <see cref="SymptomFragment"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="SymptomFragment"/> to add.</param>
        public void Add(SymptomFragment value)
        {
            base.Add(value);
        }

        /// <summary>
        /// Removes an <see cref="SymptomFragment"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="SymptomFragment"/> to remove.</param>
        public void Remove(SymptomFragment value)
        {
            base.Remove(value);
        }

        /// <summary>
        /// Inserts an <see cref="SymptomFragment"/> object to the list.
        /// </summary>
        /// <param name="index"><see cref="int"/> index position inserting at</param>
        /// <param name="value"><see cref="SymptomFragment"/> to add</param>
        public void Insert(int index, SymptomFragment value)
        {
            base.Insert(index, value);
        }

        /// <summary>
        /// Creates the <see cref="SymptomFragment"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            SymptomFragment obj = (SymptomFragment)Registry.CreateInstance(typeof(SymptomFragment), dr.GetGuid(idField));
