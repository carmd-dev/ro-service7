...
namespace Innova.Symptoms
{
    ...
    /// </remarks>
    [Serializable()]
    public class SymptomCollection : BusinessObjectCollectionBase
    {
        ...
        public SymptomCollection(Registry registry)
            : base(registry)
        {
        ...
        /// <summary>
        /// Adds an <see cref="Symptom"/> object to the list.
        /// </summary>
        /// <param name="value"><see cref="Symptom"/> to add.</param>
        public void Add(Symptom value)
        {
            base.Add(value);
        }

        /// <summary>
        /// Removes an <see cref="Symptom"/> object from the list.
        /// </summary>
        /// <param name="value"><see cref="Symptom"/> to remove.</param>
        public void Remove(Symptom value)
        {
            base.Remove(value);
        }
        ...
        /// <param name="value"><see cref="Symptom"/> to add</param>
        public void Insert(int index, Symptom value)
        {
            base.Insert(index, value);
        }

        /// <summary>
        /// Creates the <see cref="Symptom"/> object from the specified recordset supplied and optionally sets the properties of the object, then adds it to the list.
        /// </summary>
        ...
        {
            Symptom obj = (Symptom)Registry.CreateInstance(typeof(Symptom), dr.GetGuid(idField));
